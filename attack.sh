...
commands=(
    ...
    # "python -u attack.py --dataset thubenchmark --model eegnet --at_strategy fbf --fold 0 --attack fgsm --eps 0.05"
    # "python -u attack.py --dataset thubenchmark --model eegnet --at_strategy trades --fold 0 --attack fgsm --eps 0.05"

    # "python -u attack.py --dataset thubenchmark --model eegnet --at_strategy clean --fold 0 --attack pgd --eps 0.05"
    # "python -u attack.py --dataset thubenchmark --model eegnet --at_strategy madry --fold 0 --attack pgd --eps 0.05"
    # "python -u attack.py --dataset thubenchmark --model eegnet --at_strategy fbf --fold 0 --attack pgd --eps 0.05"
    # "python -u attack.py --dataset thubenchmark --model eegnet --at_strategy trades --fold 0 --attack pgd --eps 0.05"

    # "python -u attack.py --dataset thubenchmark --model eegnet --at_strategy clean --fold 0 --attack cw --eps 0.05"
    # "python -u attack.py --dataset thubenchmark --model eegnet --at_strategy madry --fold 0 --attack cw --eps 0.05"
    # "python -u attack.py --dataset thubenchmark --model eegnet --at_strategy fbf --fold 0 --attack cw --eps 0.05"
    # "python -u attack.py --dataset thubenchmark --model eegnet --at_strategy trades --fold 0 --attack cw --eps 0.05"
)
