...
源快照：2026-09-10T17:10:36.430231；沿用已核验结果，不纳入此后完成任务。
...
| seediv | atcnet | 28.93 ± 0.97 | 1.88 ± 0.23 | 5.95 ± 0.48 | 16.75 ± 6.35 | Pending(2/5) | Pending(2/5) |
| seediv | conformer | 35.17 ± 0.80 | 24.50 ± 7.64 | 5.38 ± 1.14 | 17.15 ± 3.05 | Pending(0/5) | Pending(0/5) |
| seediv | tcnet | 32.18 ± 0.32 | 0.41 ± 0.25 | 6.59 ± 0.69 | 19.37 ± 3.89 | Pending(0/5) | Pending(0/5) |
...
| seediv | atcnet | 21.27 ± 0.70 | 1.78 ± 0.23 | 4.89 ± 0.36 | 16.72 ± 5.16 | Pending(1/5) | Pending(1/5) |
| seediv | conformer | 33.29 ± 3.78 | 19.20 ± 3.48 | 7.86 ± 1.35 | 20.80 ± 3.17 | Pending(0/5) | Pending(0/5) |
| seediv | tcnet | 23.96 ± 0.38 | 0.73 ± 0.28 | 6.25 ± 0.52 | 19.24 ± 3.53 | Pending(0/5) | Pending(0/5) |
...
| seediv | atcnet | 28.28 ± 0.92 | 2.33 ± 0.31 | 6.52 ± 0.49 | 20.48 ± 6.14 | Pending(2/5) | Pending(2/5) |
| seediv | conformer | 35.11 ± 0.97 | 20.91 ± 4.09 | 7.37 ± 0.85 | 22.06 ± 3.46 | Pending(0/5) | Pending(0/5) |
| seediv | tcnet | 31.76 ± 0.24 | 0.70 ± 0.31 | 8.09 ± 0.73 | 22.53 ± 2.37 | Pending(0/5) | Pending(0/5) |
...
| seediv | atcnet | Pending(2/5) | Pending(2/5) | Pending(2/5) | Pending(2/5) | Pending(2/5) | Pending(2/5) | Pending(2/5) |
| seediv | conformer | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) |
| seediv | tcnet | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) |
...
| seediv | atcnet | Pending(2/5) | Pending(1/5) | Pending(2/5) | Pending(1/5) | Pending(1/5) | Pending(1/5) | Pending(1/5) |
| seediv | conformer | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) |
| seediv | tcnet | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) |
| bciciv2a | eegnet | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) |
| bciciv2a | deepconvnet | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending(0/5) |
...
| seediv | atcnet | Pending(2/5) | Pending(2/5) | Pending(2/5) | Pending |
| seediv | conformer | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending |
| seediv | tcnet | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending |
...
| seediv | atcnet | Pending(1/5) | Pending(1/5) | Pending(1/5) | Pending |
| seediv | conformer | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending |
| seediv | tcnet | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending |
| bciciv2a | eegnet | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending |
| bciciv2a | deepconvnet | Pending(0/5) | Pending(0/5) | Pending(0/5) | Pending |
...
- PGD、rank25：完整五种子的同范围 RPCF+TNP−Madry+TNP 对照共 9 组，平均差为正 6 组、为负 3 组、持平 0 组。该计数不是显著性检验，也不代表未完成组合。
- PGD、rank30：完整五种子的同范围 RPCF+TNP−Madry+TNP 对照共 9 组，平均差为正 6 组、为负 2 组、持平 1 组。该计数不是显著性检验，也不代表未完成组合。
- Mean4、rank25：完整五种子的同范围 RPCF+TNP−Madry+TNP 对照共 9 组，平均差为正 5 组、为负 4 组、持平 0 组。该计数不是显著性检验，也不代表未完成组合。
- Mean4、rank30：完整五种子的同范围 RPCF+TNP−Madry+TNP 对照共 9 组，平均差为正 5 组、为负 4 组、持平 0 组。该计数不是显著性检验，也不代表未完成组合。
- Clean 的完整 rank 对照有 9 组：rank30 平均更高 8 组，rank25 平均更高 1 组，持平 0 组。
- PGD 的完整 rank 对照有 9 组：rank30 平均更高 1 组，rank25 平均更高 7 组，持平 1 组。
- Mean4 的完整 rank 对照有 9 组：rank30 平均更高 0 组，rank25 平均更高 9 组，持平 0 组。
- MeanLinf3 的完整 rank 对照有 9 组：rank30 平均更高 1 组，rank25 平均更高 8 组，持平 0 组。

在当前9个完整条件中，rank25 的四攻击均值全部更高，PGD 在7个条件更高、1个持平、1个更低；rank30 的 Clean 则在8个条件更高。这表明两个净化秩在鲁棒表现与 Clean 保真之间存在经验取舍，而非某个秩在所有指标上占优。这些条件仅覆盖 THUBenchmark 的六个 backbone 和 SEED-IV 的 EEGNet、DeepConvNet、TSCeption，不代表 BCICIV2a 或未完成的 SEED-IV 条件。
...
运行：`python docs/EXP031_results_20260910_171036/build_focused_report.py`。运行会重新生成本专题报告及其派生 CSV/清单，不改变源 CSV、训练、攻击、日志或 checkpoint。
