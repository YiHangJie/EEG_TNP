...
gpu_id="${2:-0}"
eps="${3:-0.1}"
# fourth argument is the target process id, default is 0
target_pid="${4:-0}"
...
purify_commands=(
    ...
    # "python purify.py --config PTR3d_8_2048_rank45_3d_interpolate.yaml --sample_num 512 --dataset ${dataset} --attack autoattack --eps ${eps} --gpu_id ${gpu_id}"
    # "python purify.py --config PTR3d_8_2048_rank50_3d_interpolate.yaml --sample_num 512 --dataset ${dataset} --attack autoattack --eps ${eps} --gpu_id ${gpu_id}"
    # "python purify.py --config PTR3d_8_2048_rank55_3d_interpolate.yaml --sample_num 512 --dataset ${dataset} --attack autoattack --eps ${eps} --gpu_id ${gpu_id}"
    # "python purify.py --config PTR3d_8_2048_rank60_3d_interpolate.yaml --sample_num 512 --dataset ${dataset} --attack autoattack --eps ${eps} --gpu_id ${gpu_id}"
    # "python purify.py --config PTR3d_8_2048_rank30_3d_interpolate_TVft0.01.yaml --sample_num 512 --dataset ${dataset} --attack autoattack --eps ${eps} --gpu_id ${gpu_id}"
    # "python purify.py --config PTR3d_8_2048_rank30_3d_interpolate_TVft0.02.yaml --sample_num 512 --dataset ${dataset} --attack autoattack --eps ${eps} --gpu_id ${gpu_id}"
    # "python purify.py --config PTR3d_8_2048_rank30_3d_interpolate_TVft0.03.yaml --sample_num 512 --dataset ${dataset} --attack autoattack --eps ${eps} --gpu_id ${gpu_id}"
    # "python purify.py --config PTR3d_8_2048_rank30_3d_interpolate_TVft0.04.yaml --sample_num 512 --dataset ${dataset} --attack autoattack --eps ${eps} --gpu_id ${gpu_id}"
    # "python purify.py --config PTR3d_8_2048_rank30_3d_interpolate_TVft0.05.yaml --sample_num 512 --dataset ${dataset} --attack autoattack --eps ${eps} --gpu_id ${gpu_id}"
)
...
# nohup bash train_attack_purify.sh thubenchmark 0 0.01 > train_attack_purify_thubenchmark_0.01.log 2>&1 &
# nohup bash train_attack_purify.sh thubenchmark 0 0.02 > train_attack_purify_thubenchmark_0.02.log 2>&1 &
# nohup bash train_attack_purify.sh thubenchmark 0 0.05 > train_attack_purify_thubenchmark_0.05.log 2>&1 &
# nohup bash train_attack_purify.sh thubenchmark 0 0.1 > train_attack_purify_thubenchmark_0.1.log 2>&1 &
# nohup bash train_attack_purify.sh thubenchmark 0 0.2 > train_attack_purify_thubenchmark_0.2.log 2>&1 &
