...
import numpy as np
from TN.utils import  downsample_with_avg_pooling, downsample_with_wavelet, downsample_with_lanczos
from TN.save_and_plot_utils import plot_image
from PIL import Image

class BaseTNModel(torch.nn.Module):
    def __init__(self, target, init_reso, max_rank=256, dtype='float32', loss_fn_str="L2", payload=0, payload_position="grayscale", regularization_type="TV", dimensions=2, noisy_target=None, device = 'cpu', masked_avg_pooling = False, sigma_init=0):
        super().__init__()
