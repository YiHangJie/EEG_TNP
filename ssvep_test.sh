...
commands=(
    ...
    # "python -u train.py --dataset thubenchmark --model tsception --lr 0.1 --weight_decay 0"
    # "python -u train.py --dataset thubenchmark --model tsception --lr 0.01 --weight_decay 0.1"
    "python -u train.py --dataset thubenchmark --model tsception --lr 0.01 --weight_decay 0.01"
